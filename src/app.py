...
activities = {
    ...
    "Soccer Team": {
        "description": "Play matches and practice teamwork on the field",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "sarah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Develop basketball skills and compete in inter-school games",
        "schedule": "Tuesdays and Fridays, 4:30 PM - 6:00 PM",
        "max_participants": 16,
        "participants": ["james@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting, stagecraft, and perform plays together",
